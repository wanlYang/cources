...
public class WebConfig extends WebMvcConfigurationSupport {
    ...
    protected void addInterceptors(InterceptorRegistry registry) {
        ...
        interceptorRegistration.excludePathPatterns(new String[] { "/admin/login", "/admin/regist","/admin/login/submit","/admin/cources/table/list/front/end","/admin/cources/table/list/front/end/sideways","/admin/cources/table/list/front/end/sideways/all" });
